...
public class PartidoServiceImpl implements PartidoService {
    ...
    @Autowired
    public PartidoServiceImpl(PartidoRepository partidoRepository, PartidoMapper partidoMapper, CanchaService canchaService) {
    ...
    private void validarFechaYHora(PartidoDTO partido) {
        ...
        validateCanchaDate(partido);
    }

    private void validateCanchaDate(PartidoDTO partido) {
        CanchaDTO canchaDTO = canchaService.findById(partido.getCancha().getId());
        Date partidoDate = partido.getFechaComienzo();
