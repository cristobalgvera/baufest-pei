...
public class JugadorController {
    ...
    @PutMapping("/{id}/actions/calcular-ranking")
    public ResponseEntity<Void> calculateRankingById(@PathVariable Long id) {
        jugadorService.calculateRankingById(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @PutMapping("/actions/calcular-ranking-todos")
    public ResponseEntity<Void> calculateRankingAll() {
        jugadorService.calculateRankingForAll();
        return new ResponseEntity<>(HttpStatus.OK);
    }
