...
//    @JsonProperty(value = "cancha")
    ...
    public PartidoDTO(Estado estado, JugadorDTO jugadorLocal, JugadorDTO jugadorVisitante, int cantidadGamesLocal, int cantidadGamesVisitante) {
        this.estado = estado;
        this.jugadorLocal = jugadorLocal;
        this.jugadorVisitante = jugadorVisitante;
    ...
    public PartidoDTO(Long id, Date fechaComienzo, Estado estado, JugadorDTO jugadorLocal, JugadorDTO jugadorVisitante, int scoreLocal, String puntosGameActualLocal, int cantidadGamesLocal, int scoreVisitante, String puntosGameActualVisitante, int cantidadGamesVisitante, CanchaDTO cancha) {
        this.id = id;
        this.fechaComienzo = fechaComienzo;
        this.estado = estado;
        this.jugadorLocal = jugadorLocal;
